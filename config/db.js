//First file: This file is responsible for setting up a connection to your PostgreSQL database using the pg library and .env environment variables
...
//model folder will be the next one
