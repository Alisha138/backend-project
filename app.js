...
app.listen(PORT, () => {              //listen: express app method starts the server and listens on port
  console.log(`Server running on port ${PORT}`);
});

app.get('/', (req, res) => {           //get:express method for http get handling read requests (fetching, bring data) (post is vice versa) 
